...
# Try to load pilot data (private); fall back to cached results (public repo)
...
if (!is.null(rds_path)) {
  ...
  # Load pre-computed results (public repo / GH Actions)
  cache_path <- "../../materials/pilot_model_cache.rds"
  pilot_cache <- readRDS(cache_path)
  mdl2 <- NULL  # No model object
  use_cache <- TRUE
}
```
