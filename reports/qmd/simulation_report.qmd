...
**Interpretation:** The first three scenarios show very high H2 support rates (100%) because the 0–10 s effect is well outside the ROPE (smallest: $\beta = 0.294$, ROPE upper bound: $0.10$) while the 20–60 s effect is near zero. The **Minimal** scenario shows lower support (61%) and higher expected N (65.2) because both decisions are hard: the 0–10 s effect (0.20) is only 2× the ROPE half-width, and the 20–60 s effect (0.07) sits near the ROPE boundary, making the ABSENT verdict difficult to reach. 39% of Minimal simulations never decided both windows even at N=120, confirming this is a genuine sensitivity boundary.
